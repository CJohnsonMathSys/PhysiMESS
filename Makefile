...
PhysiMess_OBJECTS := PhysiMess_fibre.o PhysiMess_phenotype_fibre.o
...
PhysiMess_fibre.o: ./core/PhysiMess_fibre.cpp
	$(COMPILE_COMMAND) -c ./core/PhysiMess_fibre.cpp

PhysiMess_phenotype_fibre.o: ./core/PhysiMess_phenotype_fibre.cpp
	$(COMPILE_COMMAND) -c ./core/PhysiMess_phenotype_fibre.cpp
